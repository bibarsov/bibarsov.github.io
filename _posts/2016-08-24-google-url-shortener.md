...
### Хау-ту
Воспользоваться API очень просто. Достаточно перейти [сюда](https://goo.gl/) и вставить свою ссылку.  
...
- Создать проект в [консоли управления проектами](https://console.developers.google.com)
- Найти URL Shortener API в библиотеке API

![Google Library Pic]({{site.baseurl}}/_posts/google-library.png)
